...
func TestRequestLineParse(t *testing.T) {
	...
	assert.Equal(t, "/matcha", r.RequestLine.RequestTarget)
	assert.Equal(t, "1.1", r.RequestLine.HttpVersion)
	...
	// Test: Invalid method (not capital letters) Request line
	reader = &chunkReader{
		data:            "get / HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 8,
	}
	...
	// Test: Invalid method (unknown method) Request line
	reader = &chunkReader{
		data:            "PASTE / HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 91,
	}
...
func TestReqestCompleteHeadersParse(t *testing.T) {
...
func TestBodyParst(t *testing.T) {
	...
	reader = &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"\r\n" +
			"this is a body without content length",
		numBytesPerRead: 3,
	}
	_, err = RequestFromReader(reader)
	require.NoError(t, err)
